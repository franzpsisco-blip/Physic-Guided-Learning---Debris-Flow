# Physics-Guided Learning (Debris Flow) — minimal run guide

Repo for the manuscript (CAGEO-D-26-00304): *Debris Flow Hazard Assessment based on Multi-Sensor 3D displacements with InSAR and Physics-Guided Learning*.
